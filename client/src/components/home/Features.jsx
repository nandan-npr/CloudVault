...
const points = [
  {
    ...
    description:
      "Keep contracts, notes, briefs, and creative assets together so nothing is scattered across inboxes and desktop folders.",
    icon: FolderOpen,
  },
  {
    title: "Share without the mess",
    description:
      "Send a clean link, keep the context with the file, and avoid forwarding the same attachment over and over again.",
    icon: Share2,
  },
  {
    title: "Find what you need quickly",
    description:
      "Search by name, content, or workspace and get back to the right file without digging through layers of folders.",
    icon: Search,
  },
  {
    title: "Work from laptop or mobile",
    description:
      "Move from a desk to a train to a coffee shop without interrupting your flow or losing access to your files.",
    icon: Smartphone,
  },
  {
    title: "Preview documents before opening",
    description:
      "Open PDFs, images, and shared files without switching tools or downloading everything locally.",
    icon: FileText,
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mt-5 text-lg leading-8 text-stone-600">
            Local folders and long email chains are not a system. CloudVault gives you a practical
            home for documents, approvals, and shared work that stays clear as projects grow.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          transition={{ duration: 0.6 }}
          className="mt-12 rounded-[32px] border border-stone-200 bg-[#f8f3ea] p-8 lg:p-10"
        >
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <a
              href="#workflow"
              className="inline-flex items-center gap-2 text-sm font-semibold text-stone-700 transition hover:gap-3"
            >
