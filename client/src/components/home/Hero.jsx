      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.02fr_0.98fr]">
        ...
        >
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-stone-300 bg-white/80 px-4 py-2 text-sm font-medium text-stone-700 shadow-sm">
            <Sparkles size={16} className="text-[#8c3d3d]" />A secure home for the files that move
            your work forward
          </div>
          ...
          <p className="mt-6 text-lg leading-8 text-stone-600 sm:text-xl">
            Stop losing work inside email threads and scattered folders. CloudVault gives you one
            calm place to store, review, and share files from any device.
          </p>

          <div className="mt-10 flex flex-wrap gap-3">
            <Link
              to="/register"
              className="inline-flex items-center gap-2 rounded-full bg-[#2f1d1d] px-6 py-3 text-sm font-semibold text-[#f7efe6] transition hover:bg-[#3f2626]"
            >
              Create account
              <ArrowRight size={16} />
            </Link>
            <a
              href="#why-cloudvault"
              className="inline-flex items-center rounded-full border border-stone-300 bg-white/80 px-6 py-3 text-sm font-semibold text-stone-700 transition hover:bg-stone-50"
            >
              Why CloudVault?
            </a>
          </div>
        ...
        <motion.div
          ...
          className="rounded-[32px] border border-stone-200 bg-white/80 p-5 shadow-[0_20px_80px_rgba(45,32,20,0.08)] backdrop-blur"
        >
            ...
            <div className="mt-6 rounded-[22px] border border-stone-200 bg-white p-4">
              ...
              <div className="mt-3 rounded-2xl border border-dashed border-stone-300 bg-[#fcfaf6] p-4 text-center">
                ...
                <p className="mt-1 text-sm text-stone-500">
                  Upload from laptop or mobile in seconds
                </p>
              </div>
            </div>
